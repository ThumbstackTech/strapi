...
const TweetButton = () => {
    ...
    const handleClick = () => {
        const link = encodeURIComponent(`https://api.whatsapp.com/send?phone=918097364489&text=Hi%2C%20I%20want%20to%20know%20about%20${encodeURI(modifiedData.city)}%20id%20${encodeURI(modifiedData.Content_code)}`)
